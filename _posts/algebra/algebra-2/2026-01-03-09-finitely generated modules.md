...
(2) (a) If $V$ is a free $R$-module of rank $n<\infty$, $W\subset V$ submodule, then $W$ is free of $\rank W = m\le n$

    (b) $\exists v_1,\ldots,v_n$ be basis of $V$, $\exists b_1,\ldots,b_m\in R,\ne 0$m s.t. $b_1 v_1,\ldots,b_m v_m$ be basis of $W$. And $$b_1\mid b_2\mid \cdots \mid b_m$$
:::
...
4.  $\mathbb{Z}^{\oplus \NN}$ is not a noetherain $\mathbb{Z}$-mod since it's not f.g.
...
means $f,g$ be $R$-linear map. $f$ is injective, $g$ is surjective, $\im f = \ker g$.
