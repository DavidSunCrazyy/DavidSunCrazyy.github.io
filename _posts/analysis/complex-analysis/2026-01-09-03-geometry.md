...
则 $f\circ \varphi(0)=0$。对 $f$ 和 $f^{-1}$ 应用 Schwarz 引理我们可以得到 $\|f(z)\|\ge \|z\|$ 且 $\|f^{-1}(z)\|\ge \|z\|\mathrm{Im}plies\|z\|\ge \|f(z)\|$。
...
$\mathrm{Im}plies$ $$L(\gamma) = \int\_a^b \frac{2\|(\gamma'(t)+i\gamma(t)\varphi'(t))e^{i\varphi(t)}\|}{1-\|r(t)\|^2}dt
...
对于 (ii)，如果 (i) 成立，只需检查如果 $\infty \in U$，$\exists M = \frac{1}{\varepsilon}$ 使得如果 $\|z\|>M \mathrm{Im}plies z\in U$。
...
利用 $\mathbb{CP}^1 \cong \hat{\mathbb{C}}$ 我们得到 $g(z) = \frac{az+b}{cz+d}\in \mathcal{M}(\mathbb{C})$。$\mathrm{Im}plies g\in \\operatorname{Aut}(\tilde{\mathbb{C}})$。
...
$\varphi: \\operatorname{Aut}(\hat{\mathbb{C}}) \mathrm{Im}plies \varphi = p/q, p,q\in \mathbb{C}[z]$。 不妨设 $p,q$ 互质。
...
$\mathrm{Im}plies$ 由 $S\_z(f)$ 的一次推导得出。
    ...
    由 $1=u'v-uv' = \det \begin{pmatrix}
        ...
        \end{pmatrix}$ 我们得到 $0 = \det \begin{pmatrix}
            ...
            \end{pmatrix}'' & \begin{pmatrix}
                u \\ v
            \end{pmatrix}
        \end{pmatrix}$ $\iff$ $u'' = \lambda u, v'' = \lambda v$，其中 $\lambda = \frac{u''}{u} = \frac{v''}{v} = \frac{1}{2} S\_z(f)$ $\mathrm{Im}plies u''=0, v''=0$ $\mathrm{Im}plies f$ 是 Möbius 变换。
