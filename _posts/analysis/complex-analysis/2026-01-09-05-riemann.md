...
tags: [complex-analysis, riemann-mapping-theorem, conformal-mappings, simply-connected, normal-families]
use_math: true
---
...
对于 $z,w\in D_r(p)$, 我们有 $$\|f_n(z) -f_n(w)\| = \frac{1}{2\pi i}\int_{\|\zeta-p\|=2r} \frac{f_n(\zeta)}{\zeta-z} - \frac{f_n(s)}{\zeta - w} ds = \frac{z-w}{2\pi i} \int_{\|\zeta-p\|=2r} \frac{f_n(\zeta)}{(\zeta-z)(\zeta-\omega)} d\zeta.$$
