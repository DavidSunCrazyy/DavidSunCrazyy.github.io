...
tags: [complex-analysis, differential-equations, complex-ode, fuchsian-theory, monodromy]
use_math: true
---
...
设 $\gamma$ 和 $\tilde{\gamma}$ 是在 $U$ 中同伦的两条曲线，考虑ODE $y'+A(z) y =0$，其中 $A:U\to gl(n,\mathbb{C})$ 全纯，以及对应的两个实ODE $$V_k'(t) + j_k (t) A(\gamma_k(t)) V_k(t) = 0.$$
