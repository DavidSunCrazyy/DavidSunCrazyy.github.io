...
2.  当$t < T$时循环执行
    ...
    1.  选取 $I_{t+1} = \arg\max\_{i \in [n]} \left\\{ \hat{\mu}\_i(t) + \underbrace{\mathrm{CI}\_i(t)}\_{\substack{\text{置信区间半径} \\ = \sqrt{\frac{\ln(2T)}{T_i(t)}}}} \right\\}$
...
当事件 $\mathcal{E}$ 发生时，有 $\Delta\_{I_{t+1}} = \mu_1 - \mu\_{I\_{t+1}} \leq 2 \cdot \mathrm{CI}\_{I_{t+1}}(t) = 2 \cdot \sqrt{\frac{\ln(2T)}{T_{I_{t+1}}(t)}}$
