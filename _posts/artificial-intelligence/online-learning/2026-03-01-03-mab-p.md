...
tags: [online-learning, multi-armed-bandits, pure-exploration, best-arm-identification, fixed-confidence]
use_math: true
---
...
3. 令 $S_r$ 为 $S_{r-1}$ 中 $\hat{\mu}_{i,r}$ 值最高的 $\frac{\|S_{r-1}\|}{2}$ 个臂。
