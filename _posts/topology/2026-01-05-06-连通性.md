...
categories: topology
tags: [topology, connectedness, path-connected, connected-components, locally-connected, totally-disconnected]
use_math: true
---
...
**前置知识**：拓扑空间基础、连续映射
**核心思想**：连通性刻画空间的"整体性"，是拓扑不变量，用于区分不同拓扑空间的本质特征
...
下一节：[商空间和商映射](/posts/topology-quotient-spaces/)